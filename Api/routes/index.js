...
router.put('/parcels/:parcelId/cancel', verifyUserToken, parcelIdValidation, controller.deleteOrder);
router.put('/parcels', postIdValidation);
router.delete('/users/:userId/parcels/', verifyUserToken, verifyAdmin, userIdValidation, controller.deleteUserOrder);
router.delete('/parcels', postIdValidation);
